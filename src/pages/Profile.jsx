...
function Profile() {
  ...
  const onSubmit = async () => {
    try {
      ...
      toast.error('Виникла помилка з оновленням особистих даних');
    }
  };
    ...
    <div className="profile">
      ...
      <main>
        <div className="profileDetailsHeader">
          <p className="profileDetailsText">Особисті дані</p>
          <p
